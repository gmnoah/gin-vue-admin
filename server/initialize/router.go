...
func Routers() *gin.Engine {
	...
	{
		cnSystemRouter := router.RouterGroupApp.CnSystem
		cnSystemRouter.InitSysDeptRouter(PrivateGroup)
		cnSystemRouter.InitClientDeviceRouter(PrivateGroup)
		cnSystemRouter.InitDeviceDataTemplateRouter(PrivateGroup)
